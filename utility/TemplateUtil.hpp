...
template <template <bool ...> class T, class ReturnT,
          ...
          typename Tuple>
inline ReturnT* CreateBoolInstantiatedInstanceInner(Tuple &&args, //  NOLINT
                                                    Sequence<i...> &&indices) {  //  NOLINT
...
template <template <bool ...> class T, class ReturnT,
          bool ...bool_values,
          typename Tuple>
inline ReturnT* CreateBoolInstantiatedInstance(Tuple &&args) { //  NOLINT
