...
class WindowAggregateFunction {
 public:
   ...
   *
   * @param arguments A list of zero or more  arguments to
   *                  this WindowAggregateFunction.
   * @param partition_by_attributes A list of attributes used as partition key.
   * @param streaming_attribute The streaming attribute.
  ...
  virtual WindowAggregationHandle* createHandle(
      ...
      const TypedValue value_following) const = 0;
